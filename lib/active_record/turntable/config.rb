...
module ActiveRecord::Turntable
  class Config
    ...
    def [](key)
      self.class.load!(ActiveRecord::Base.turntable_configuration_file) unless @config
      @config[key]
    end

    def self.load!(config_file = ActiveRecord::Base.turntable_configuration_file, env = (defined?(Rails) ? Rails.env : "development"))
    ...
    def load!(config_file, env)
      ...
      # TODO: Remove this hook that was renamed to `turntable_configuration_loaded`
